package com.example.bookswap.location
...
class LocationService : Service() {
    ...
    private val notifiedBooks = mutableSetOf<String>()
    ...
    private fun createNotificationChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = "Obaveštavamo vas da se vaša lokacija prati u pozadini kako bi se proverilo da li ste u blizini neke knjižare"
            }
    ...
    private fun checkProximityToBooks(latitude: Double, longitude: Double) {
            ...
            .addOnSuccessListener { result ->
                for (document in result) {
                    ...
                    geoPoint?.let {
                        ...
                        if (distance <= 100 && !notifiedBooks.contains(document.id)) {
                            sendNearbyBookNotification()
                            notifiedBooks.add(document.id)
    ...
    private fun sendNearbyBookNotification() {
        val notificationChannelId = "LOCATION_SERVICE_CHANNEL"
        ...
        val notification = NotificationCompat.Builder(this, notificationChannelId)
            .setContentTitle("Knjižara u blizini")
            .setContentText("Nalazite se u blizini neke knjižare!")
            .setSmallIcon(R.drawable.logo)
            .setContentIntent(pendingIntent)
            .build()
    ...
    companion object {
        ...
        private const val NEARBY_BOOK_NOTIFICATION_ID = 2
    }
}
