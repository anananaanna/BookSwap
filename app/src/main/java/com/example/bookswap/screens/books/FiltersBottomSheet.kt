...
import com.example.bookswap.ui.theme.redTextColor
...
fun FiltersBottomSheet(
    ...
    Column(
        ...
        CustomFilterButton {
            val filteredBooks = books.toMutableList()

            Log.d("MojaLokacija", filteredBooks.count().toString())
            if (rangeValues.floatValue != 1000f) {
                filteredBooks.retainAll { book ->
                    calculateDistance(
            ...
            if (selectedCrowd.isNotEmpty()) {
                filteredBooks.retainAll { it.crowd in selectedCrowd }
            ...
            if (selectedOptions.value.indexOf(true) != -1) {
                ...
                filteredBooks.retainAll { it.userId in selectedIndices }
            ...
            filteredBook.clear()
            filteredBook.addAll(filteredBooks)
